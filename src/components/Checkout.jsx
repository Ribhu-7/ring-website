  ...
  return (
    ...
    <div className="row g-5">
      <div className="col-md-5 col-lg-4 order-md-last">
        ...
        <form className="card p-2" onSubmit={()=>{console.log("Your order has been placed!")}}>
      ...
      <div className="col-md-7 col-lg-8">
        ...
        <form className="needs-validation" novalidate="">
          <div className="row g-3">
            ...
            <div className="col-12">
              <label for="email" className="form-label">Email <span>(Optional)</span></label>
            ...
            <div className="col-12">
              <label for="address2" className="form-label">Address 2 <span>(Optional)</span></label>
          ...
          <Link to="/end"><button onClick={()=> emptyCart()} className="w-100 btn btn-primary btn-lg" type="submit">Continue to checkout</button></Link>
        </form>
      </div>
    </div>
    </div>
